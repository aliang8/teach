...
from teacher_forcing.config import exp_ingredient, train_ingredient
from teacher_forcing.data import TATCDataset, GuidesSpeakerDataset
...
def create_model(args, emb_ann, vocab_out, vocab):
    ...
    if args.resume:
        ...
        model = M.Seq2SeqFollowerAgent(args, vocab)
        optimizer = None
...
def load_data(name, args, ann_type, valid_only=False):
    ...
    for partition in partitions:
        ...
        elif args.model in ["transformer", "seq2seq_im_mask", "seq2seq"]:
