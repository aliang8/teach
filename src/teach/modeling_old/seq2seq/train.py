...
def create_datasets():
    ...
    for partition in data_partitions:
        dataset = TATCDataset(args.data.train, partition, args, args.data.ann_type)
    ...
    for dataset in datasets:
        loader = torch.utils.data.DataLoader(dataset, args.batch_size, shuffle=True, **loader_args)
